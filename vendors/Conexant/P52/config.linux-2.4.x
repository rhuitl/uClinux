...
# CONFIG_ARCH_CX821XX is not set
CONFIG_IAD_EVM=y
# CONFIG_HORNET is not set
...
# CONFIG_CPU_ARM940_CPU_IDLE is not set
# CONFIG_CPU_ARM940_I_CACHE_ON is not set
# CONFIG_CPU_ARM940_D_CACHE_ON is not set

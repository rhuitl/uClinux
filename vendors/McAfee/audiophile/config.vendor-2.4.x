...
# CONFIG_USER_MP3PLAY_SWAP_WD is not set
CONFIG_USER_OGGPLAY_OGGPLAY=y
# CONFIG_USER_OGGPLAY_EXAMPLE is not set
# CONFIG_USER_MUSICBOX_MUSICBOX is not set
CONFIG_USER_PLAY_PLAY=y
...
CONFIG_USER_BUSYBOX_HDPARM=y
CONFIG_USER_BUSYBOX_FEATURE_HDPARM_GET_IDENTITY=y
# CONFIG_USER_BUSYBOX_FEATURE_HDPARM_HDIO_SCAN_HWIF is not set
# CONFIG_USER_BUSYBOX_FEATURE_HDPARM_HDIO_UNREGISTER_HWIF is not set
# CONFIG_USER_BUSYBOX_FEATURE_HDPARM_HDIO_DRIVE_RESET is not set
# CONFIG_USER_BUSYBOX_FEATURE_HDPARM_HDIO_TRISTATE_HWIF is not set
# CONFIG_USER_BUSYBOX_FEATURE_HDPARM_HDIO_GETSET_DMA is not set
...
CONFIG_USER_BUSYBOX_FEATURE_IFCONFIG_STATUS=y
# CONFIG_USER_BUSYBOX_FEATURE_IFCONFIG_SLIP is not set
# CONFIG_USER_BUSYBOX_FEATURE_IFCONFIG_MEMSTART_IOADDR_IRQ is not set
CONFIG_USER_BUSYBOX_FEATURE_IFCONFIG_HW=y
# CONFIG_USER_BUSYBOX_FEATURE_IFCONFIG_BROADCAST_PLUS is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_IPCALC_LONG_OPTIONS is not set

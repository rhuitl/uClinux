...
CONFIG_USER_CGI_WIZARD_NO_WAN=y
...
CONFIG_USER_SWTEST_SWITCH_NUM=2
# CONFIG_USER_SWTEST_SINGLE_PHYADDR is not set
CONFIG_USER_SWTEST_RTL8305SB=y
...
CONFIG_USER_MTDUTILS_NFTLDUMP=y
CONFIG_USER_MTDUTILS_NFTL_FORMAT=y
...
CONFIG_USER_MTDUTILS_DOC_LOADBIOS=y
CONFIG_USER_MTDUTILS_DOC_LOADIPL=y
...
# CONFIG_USER_CLAMAV_NODB is not set

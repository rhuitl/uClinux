...
# CONFIG_USER_FLASH_BOOT_LOCKED is not set
# CONFIG_USER_FLASH_TAGS_LOCKED is not set
CONFIG_USER_FLASH_TAG_BASE=0x0
CONFIG_USER_FLASH_TAG_OFFSET=0x0
CONFIG_USER_FLASH_TAG_SIZE=0x0
CONFIG_USER_FLASH_TAG_ERASED=0xff
# CONFIG_USER_FLASH_LEGACY is not set
...
CONFIG_SIZE_CONNTRACK=0
CONFIG_SIZE_RT_CACHE=0
...
# CONFIG_LANG_ETSEC is not set
# CONFIG_LANG_CHINESE is not set
# CONFIG_LANG_ZHCN is not set
# CONFIG_LANG_ZHTW is not set
...
# CONFIG_USER_DNSMASQ2_DNSMASQ2 is not set
...
# CONFIG_USER_IPROUTE2_IP_GENL is not set
CONFIG_USER_IPROUTE2_IP_RTPR=y
...
CONFIG_USER_PPPD_PPPOE_RETRIES=6
...
# CONFIG_USER_SSH_SCP is not set
# CONFIG_USER_SSH_SFTP is not set
# CONFIG_USER_SSH_SFTP_SERVER is not set
...
# CONFIG_USER_ZEBRA_BGPD_BGPD is not set
# CONFIG_USER_ZEBRA_OSPFD_OSPFD is not set
...
CONFIG_USER_HOSTAP_PCI=y
# CONFIG_USER_HOSTAP_CS is not set
...
# CONFIG_USER_CRYPTO_TOOLS_CMACTEST is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_VERBOSE_USAGE is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_PIDFILE is not set
# CONFIG_USER_BUSYBOX_FEATURE_SUID is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_FAST_TOP is not set
# CONFIG_USER_BUSYBOX_FEATURE_ETC_NETWORKS is not set
# CONFIG_USER_BUSYBOX_FEATURE_EDITING is not set
# CONFIG_USER_BUSYBOX_FEATURE_VERBOSE_CP_MESSAGE is not set
...
# Archival Utilities
#
CONFIG_USER_BUSYBOX_AR=y
# CONFIG_USER_BUSYBOX_FEATURE_AR_LONG_FILENAMES is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_DF_INODE is not set
...
# CONFIG_USER_BUSYBOX_TRUE is not set
...
#
# CONFIG_USER_BUSYBOX_FEATURE_HUMAN_READABLE is not set
...
# CONFIG_USER_BUSYBOX_DEBUG_INIT is not set
CONFIG_USER_BUSYBOX_FEATURE_USE_INITTAB=y
CONFIG_USER_BUSYBOX_FEATURE_KILL_REMOVED=y
CONFIG_USER_BUSYBOX_FEATURE_KILL_DELAY=0
# CONFIG_USER_BUSYBOX_FEATURE_INIT_SCTTY is not set
# CONFIG_USER_BUSYBOX_FEATURE_INIT_SYSLOG is not set
CONFIG_USER_BUSYBOX_FEATURE_EXTRA_QUIET=y
# CONFIG_USER_BUSYBOX_FEATURE_INIT_COREDUMPS is not set
CONFIG_USER_BUSYBOX_FEATURE_INITRD=y
...
# CONFIG_USER_BUSYBOX_FEATURE_INSMOD_VERSION_CHECKING is not set
# CONFIG_USER_BUSYBOX_FEATURE_INSMOD_KSYMOOPS_SYMBOLS is not set
# CONFIG_USER_BUSYBOX_FEATURE_INSMOD_LOADINKMEM is not set
# CONFIG_USER_BUSYBOX_FEATURE_INSMOD_LOAD_MAP is not set
CONFIG_USER_BUSYBOX_RMMOD=y
CONFIG_USER_BUSYBOX_LSMOD=y
# CONFIG_USER_BUSYBOX_FEATURE_LSMOD_PRETTY_2_6_OUTPUT is not set
...
CONFIG_USER_BUSYBOX_FEATURE_2_4_MODULES=y
...
CONFIG_USER_BUSYBOX_PIVOT_ROOT=y
...
#
# CONFIG_USER_BUSYBOX_FEATURE_MOUNT_LOOP is not set
...
CONFIG_USER_BUSYBOX_MAKEDEVS=y
...
# CONFIG_USER_BUSYBOX_SCRIPT is not set
...
# CONFIG_USER_BUSYBOX_TTYSIZE is not set
...
# CONFIG_USER_KISMET is not set
# CONFIG_USER_LUA is not set

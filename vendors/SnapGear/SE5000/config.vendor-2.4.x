...
CONFIG_USER_FLATFSD_DISKLIKE=y
...
CONFIG_USER_BUSYBOX_DEALLOCVT=y
...
CONFIG_USER_BUSYBOX_MKSWAP=y
# CONFIG_USER_BUSYBOX_FEATURE_MKSWAP_V0 is not set
...
CONFIG_USER_BUSYBOX_SWAPONOFF=y

...
# CONFIG_USER_PAM_KRB5 is not set
...
CONFIG_USER_FLASH_BOOT_LOCKED=y
CONFIG_USER_FLASH_TAGS_LOCKED=y
CONFIG_USER_FLASH_TAG_BASE=0x02000000
CONFIG_USER_FLASH_TAG_OFFSET=0x1d000
CONFIG_USER_FLASH_TAG_SIZE=0x2000
CONFIG_USER_FLASH_TAG_ERASED=0xff
CONFIG_USER_FLASH_LEGACY=y
# CONFIG_USER_CGI_ETH1_BRIDGE is not set
# CONFIG_USER_CGI_NO_SERIAL is not set
# CONFIG_USER_CGI_NO_SERIALNUM is not set
...
# CONFIG_USER_CGI_CONNGROUP is not set
...
CONFIG_SIZE_CONNTRACK=4096
CONFIG_SIZE_RT_CACHE=16384
...
#
CONFIG_SIZE_VAR_PART=128
CONFIG_SIZE_CONFIG_PART=128
CONFIG_SIZE_SYSLOG_MAXSIZE=16
CONFIG_STATS_POLL_PERIOD=20
CONFIG_STATS_NUM_SAMPLES=180
CONFIG_STATS_SAMPLING_FREQUENCY=1
...
# CONFIG_USER_IPUTILS_PING6 is not set
# CONFIG_USER_IPUTILS_TRACEROUTE6 is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_SYSLOG is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_2_6_MODULES is not set
CONFIG_USER_BUSYBOX_FEATURE_QUERY_MODULE_INTERFACE=y
...
# Ash Shell Options
#
# CONFIG_USER_BUSYBOX_ASH_JOB_CONTROL is not set
# CONFIG_USER_BUSYBOX_ASH_READ_NCHARS is not set
# CONFIG_USER_BUSYBOX_ASH_READ_TIMEOUT is not set
# CONFIG_USER_BUSYBOX_ASH_ALIAS is not set
# CONFIG_USER_BUSYBOX_ASH_MATH_SUPPORT is not set
# CONFIG_USER_BUSYBOX_ASH_GETOPTS is not set
CONFIG_USER_BUSYBOX_ASH_BUILTIN_ECHO=y
CONFIG_USER_BUSYBOX_ASH_BUILTIN_TEST=y
# CONFIG_USER_BUSYBOX_ASH_CMDCMD is not set
# CONFIG_USER_BUSYBOX_ASH_MAIL is not set
CONFIG_USER_BUSYBOX_ASH_OPTIMIZE_FOR_SIZE=y
# CONFIG_USER_BUSYBOX_ASH_RANDOM_SUPPORT is not set
# CONFIG_USER_BUSYBOX_ASH_EXPAND_PRMT is not set

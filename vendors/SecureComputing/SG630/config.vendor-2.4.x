...
# CONFIG_USER_CGI_FAILOVER is not set
...
# CONFIG_USER_CGI_WIZARD is not set
...
CONFIG_USER_FIREWALL_BRIDGE_LAN=y
...
#
CONFIG_SIZE_VAR_PART=256
CONFIG_SIZE_CONFIG_PART=256
...
# CONFIG_USER_QUAGGA_OSPFD_OSPFD is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_EDITING_VI is not set
CONFIG_USER_BUSYBOX_FEATURE_EDITING_HISTORY=15
# CONFIG_USER_BUSYBOX_FEATURE_EDITING_SAVEHISTORY is not set
CONFIG_USER_BUSYBOX_FEATURE_TAB_COMPLETION=y
# CONFIG_USER_BUSYBOX_FEATURE_USERNAME_COMPLETION is not set
# CONFIG_USER_BUSYBOX_FEATURE_EDITING_FANCY_PROMPT is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_FANCY_ECHO is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_LS_COLOR is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_MOUNT_FSTAB is not set
...
# CONFIG_USER_BUSYBOX_ASH_BUILTIN_ECHO is not set
# CONFIG_USER_BUSYBOX_ASH_BUILTIN_TEST is not set

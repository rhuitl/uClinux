...
# CONFIG_LIB_LIBNL_ROUTE_ADDR is not set
CONFIG_LIB_LIBNL_ROUTE_LINK=y
# CONFIG_LIB_LIBNL_ROUTE_NEIGH is not set
# CONFIG_LIB_LIBNL_ROUTE_ROUTE is not set
# CONFIG_LIB_LIBNL_ROUTE_RULE is not set
# CONFIG_LIB_LIBNL_ROUTE_TC is not set
# CONFIG_LIB_LIBNL_GENERIC is not set
# CONFIG_LIB_LIBNL_FIB is not set
CONFIG_LIB_LIBNL_NETFILTER=y
CONFIG_LIB_LIBNL_NETFILTER_CT=y
CONFIG_LIB_LIBNL_NETFILTER_LOG=y
# CONFIG_LIB_LIBNL_NETFILTER_QUEUE is not set
...
CONFIG_USER_TRUSTEDSOURCE_BLACKLIST=y
...
# CONFIG_USER_DNSMASQ2_RESOLVE_AS_SERVER is not set
...
CONFIG_USER_CRYPTO_TOOLS_CRYPTOTEST=y
CONFIG_USER_CRYPTO_TOOLS_CRYPTOKEYTEST=y

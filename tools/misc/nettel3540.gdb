#
# GDB Init script for the NETtel/3450 (ADSL) ColdFire 5307 board.
#
...
set *((unsigned long *) $csmr0)  = 0x007f0001
...
# CS4 -- 2nd Ethernet, address=0x30800000
...
#
#	NETtel/3450 (ADSL) ColdFire 5307 target...
#

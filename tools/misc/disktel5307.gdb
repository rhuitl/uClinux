#
# GDB Init script for the DISKtel ColdFire 5307 board.
#
...
define setup-pp
set *((unsigned short *) $par) = 0xc000
set *((unsigned short *) $paddr) = 0x3000
...
set *((unsigned long *) $csmr0)  = 0x000f0001
set *((unsigned short *) $cscr0) = 0x3d80

# CS1 -- Nothing
set *((unsigned short *) $csar1) = 0xf800
set *((unsigned long *) $csmr1)  = 0x000f0001
set *((unsigned short *) $cscr1) = 0x3d80

# CS2-7 are at 0x30000000
set *((unsigned short *) $csbar)  = 0x3000
set *((unsigned short *) $csbamr) = 0x0000

# CS2 -- Nothing, address=0x30400000
set *((unsigned short *) $csmr2)  = 0x0001
set *((unsigned short *) $cscr2) = 0x3d40

# CS3 -- Ethernet, address=0x30600000
set *((unsigned short *) $csmr3)  = 0x0001
set *((unsigned short *) $cscr3) = 0x3d80

# CS4 -- Nothing, address=0x30800000
set *((unsigned short *) $csmr4)  = 0x0001
set *((unsigned short *) $cscr4) = 0x3d40

# CS5 -- Nothing, address=0x30a00000
set *((unsigned short *) $csmr5)  = 0x0001
set *((unsigned short *) $cscr5) = 0x3d40

# CS6 -- IDE interface, address=0x30c00000
set *((unsigned short *) $csmr6)  = 0x0001
set *((unsigned short *) $cscr6) = 0x0040

# CS7 -- Nothing, address=0x30e00000
set *((unsigned short *) $csmr7)  = 0x0001
...
#
#	Init for DISKtel ColdFire target...
#

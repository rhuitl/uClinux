 ...
 *
 * $Log: h4601.cxx,v $
 * Revision 1.12  2006/06/11 00:17:43  csoutheren
 * Added pragma for old gcc compilers
 *
 * Revision 1.11  2006/06/09 06:30:12  csoutheren
 * Remove compile warning and errors with gcc
 *
 * Revision 1.10  2006/06/08 13:26:16  shorne
 * Resyn Opal and OpenH323 versions
 *
 * Revision 1.9  2006/06/08 11:50:06  shorne
 * Fix for compiling under linux
 *
 * Revision 1.8  2006/05/30 17:20:46  shorne
 * revert part of last change and alter function call
 *
 * Revision 1.7  2006/05/30 11:16:52  hfriederich
 * Fix compiler errors and warning for gcc4
 *
 * Revision 1.6  2006/05/27 03:28:22  shorne
...
{ 
	...
	return (H323TransportAddress &)content;
...
BOOL H460_FeatureSet::CreateFeatureSetPDU(H225_FeatureSet & fs, unsigned MessageID)
{
	...
	PTRACE(4,"H460\tFeatureSet for " << PTracePDU(MessageID) << " PDU\n" << fs);

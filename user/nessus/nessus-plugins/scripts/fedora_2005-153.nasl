...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2005-153: squid";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-153 (squid).
...
include("rpm.inc");
if ( rpm_check( reference:"squid-2.5.STABLE8-1.FC2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}

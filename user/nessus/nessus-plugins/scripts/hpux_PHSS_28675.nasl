...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_28675";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_28675 .
(SSRT3492 libDtSvc)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_28675
See also : HPUX security bulletin 308
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_28675";
...
if ( hpux_patch_installed (patches:"PHSS_28675 PHSS_29734 PHSS_30010 PHSS_30668 PHSS_32107 PHSS_32539 PHSS_35433 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "Fedora Core 4 2005-1144: perl";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-1144 (perl).
...
include("rpm.inc");
if ( rpm_check( reference:"perl-5.8.6-22", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"perl-suidperl-5.8.6-22", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"perl-debuginfo-5.8.6-22", release:"FC4") )
{
 security_hole(0);
 exit(0);
}

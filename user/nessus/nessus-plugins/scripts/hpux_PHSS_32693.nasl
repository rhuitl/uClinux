...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_32693";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_32693 .
...
Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32693
See also : HPUX security bulletin 1140
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_32693";
...
if ( hpux_patch_installed (patches:"PHSS_32693 PHSS_32817 PHSS_33073 PHSS_33223 PHSS_33345 PHSS_33460 PHSS_33663 PHSS_34099 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_10789";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_10789 .
(Security Vulnerability in libXt for HP-UX 9.X & 10.X)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_10789
See also : HPUX security bulletin 058
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_10789";

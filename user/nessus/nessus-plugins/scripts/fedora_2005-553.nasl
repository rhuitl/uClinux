...
if(description)
{
 ...
 script_cve_id("CVE-2004-0175", "CVE-2005-0469", "CVE-2005-0488", "CVE-2005-1174", "CVE-2005-1175", "CVE-2005-1689");
 
 name["english"] = "Fedora Core 4 2005-553: krb5";
...
flaw remotely, an attacker would need to have control of a kerberos realm
...
may attempt to free uninitialized memory.  This could allow a remote
...
Solution : http://fedoranews.org//mediawiki/index.php/Fedora_Core_4_Update:_krb5-1.4.1-5
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"krb5-devel-1.4.1-5", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-libs-1.4.1-5", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-server-1.4.1-5", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-workstation-1.4.1-5", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-debuginfo-1.4.1-5", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_exists(rpm:"krb5-", release:"FC4") )
{

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_13772";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_13772 .
(Security Vulnerability in CDE on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_13772
See also : HPUX security bulletin 075
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_13772";
...
if ( hpux_patch_installed (patches:"PHSS_13772 PHSS_14875 PHSS_16197 PHSS_19702 PHSS_19819 PHSS_22546 PHSS_23848 PHSS_24097 PHSS_25419 PHSS_26029 PHSS_28173 ") )
{
 exit(0);
}

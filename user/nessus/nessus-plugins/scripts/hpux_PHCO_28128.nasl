...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_28128";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_28128 .
(SSRT2336 Rev.5 XDR library)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHCO_28128
See also : HPUX security bulletin 215
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_28128";
...
if ( hpux_patch_installed (patches:"PHCO_28128 PHCO_30063 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-128: subversion";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-128 (subversion).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-128.shtml
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"subversion-1.0.2-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"subversion-devel-1.0.2-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"mod_dav_svn-1.0.2-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"subversion-perl-1.0.2-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"subversion-debuginfo-1.0.2-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}

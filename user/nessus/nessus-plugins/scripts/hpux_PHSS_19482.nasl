...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_19482";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_19482 .
(Security Vulnerability in rpc.cmsd)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_19482
See also : HPUX security bulletin 102
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_19482";
...
if ( hpux_patch_installed (patches:"PHSS_19482 PHSS_19747 PHSS_20715 PHSS_20860 PHSS_22319 PHSS_22339 PHSS_23516 PHSS_23796 PHSS_23798 PHSS_25137 PHSS_25192 PHSS_25786 PHSS_26489 PHSS_27426 PHSS_27877 PHSS_29201 ") )
{
 exit(0);
}

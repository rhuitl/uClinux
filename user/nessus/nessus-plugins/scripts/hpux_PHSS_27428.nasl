...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_27428";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_27428 .
(Potential Sec. Vulnerability in rpc.ttdbserver)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_27428
See also : HPUX security bulletin 199
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_27428";
...
if ( hpux_patch_installed (patches:"PHSS_27428 PHSS_27872 PHSS_28676 PHSS_29735 PHSS_30011 PHSS_30788 PHSS_32110 PHSS_33325 PHSS_35249 ") )
{
 exit(0);
}

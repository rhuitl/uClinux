# This script was automatically generated from the SSA-2004-124-03
...
script_summary("SSA-2004-124-03 xine-lib update ");
name["english"] = "SSA-2004-124-03 xine-lib update ";
...
if (slackware_check(osver: "9.1", pkgname: "xine-lib", pkgver: "1rc4", pkgnum:  "1", pkgarch: "i686")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
The package xine-lib is vulnerable in Slackware 9.1
Upgrade to xine-lib-1rc4-i686-1 or newer.
');
}
if (slackware_check(osver: "-current", pkgname: "xine-lib", pkgver: "1rc4", pkgnum:  "1", pkgarch: "i686")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '

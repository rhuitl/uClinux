...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_34098";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_34098 .
...
Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHSS_34098
See also : HPUX security bulletin 2098
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_34098";
...
if ( hpux_patch_installed (patches:"PHSS_34098 ") )
{
 exit(0);
}

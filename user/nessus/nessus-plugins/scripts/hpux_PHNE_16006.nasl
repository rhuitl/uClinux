...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_16006";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_16006 .
(Security Vulnerability with ftp on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHNE_16006
See also : HPUX security bulletin 079
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_16006";
...
if ( hpux_patch_installed (patches:"PHNE_16006 PHNE_22703 ") )
{
 exit(0);
}

if ( hpux_check_patch( app:"BLS.MAXSIX", version:NULL) )
{
 security_hole(0);
 exit(0);
}

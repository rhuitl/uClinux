...
if(description)
{
 ...
 name["english"] = "Fedora Core 3 2005-1130: curl";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-1130 (curl).
...
include("rpm.inc");
if ( rpm_check( reference:"curl-7.12.3-5.fc3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"curl-devel-7.12.3-5.fc3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}

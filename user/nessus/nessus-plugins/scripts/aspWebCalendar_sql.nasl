...
if(description)
{
 ...
 name["english"] = "aspWebCalendar SQL Injection";
...
foreach dir (cgi_dirs()) 
 {
  if ( is_cgi_installed_ka(item:dir + "/calendar.asp", port:port) ) check(req:dir + "/calendar.asp?action=processlogin");
 }

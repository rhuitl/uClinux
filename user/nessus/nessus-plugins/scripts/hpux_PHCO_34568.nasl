...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_34568";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_34568 .
(SSRT061115 rev.1 - HP-UX Running Software Distributor Local Elevation of Privilege)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHCO_34568
See also : HPUX security bulletin 2114
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_34568";
...
if ( hpux_patch_installed (patches:"PHCO_34568 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_23483";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_23483 .
((VVOS) SD-UX Cumulative Patch)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHCO_23483
See also : HPUX security bulletin 143
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_23483";

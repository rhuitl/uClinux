...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_34936";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_34936 .
(SSRT061159 rev.2 - HP-UX Sendmail MIME Remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHNE_34936
See also : HPUX security bulletin 2124
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_34936";
...
if ( hpux_patch_installed (patches:"PHNE_34936 ") )
{
 exit(0);
}

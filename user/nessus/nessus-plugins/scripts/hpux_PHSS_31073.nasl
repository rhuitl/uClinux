...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_31073";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_31073 .
(SSRT3526 rev.0 Serviceguard potential increase in privilege)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_31073
See also : HPUX security bulletin 1080
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_31073";
...
if ( hpux_patch_installed (patches:"PHSS_31073 PHSS_31077 PHSS_32732 ") )
{
 exit(0);
}

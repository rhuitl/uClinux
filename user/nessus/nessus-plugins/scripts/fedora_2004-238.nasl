...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-238: libpng10";
...
include("rpm.inc");
if ( rpm_check( reference:"libpng10-1.0.15-8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"libpng10-devel-1.0.15-8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"libpng10-debuginfo-1.0.15-8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_exists(rpm:"libpng10-", release:"FC2") )
{

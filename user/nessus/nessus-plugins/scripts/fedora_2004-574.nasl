...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-574: cups";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-574 (cups).
...
Solution : http://www.fedoranews.org/blog/index.php?p=230
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"cups-1.1.20-11.8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"cups-devel-1.1.20-11.8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"cups-libs-1.1.20-11.8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"cups-debuginfo-1.1.20-11.8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}

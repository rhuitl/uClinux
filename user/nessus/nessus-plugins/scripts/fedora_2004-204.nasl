...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-204: httpd";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-204 (httpd).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-204.shtml
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"httpd-2.0.50-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"httpd-devel-2.0.50-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"httpd-manual-2.0.50-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"mod_ssl-2.0.50-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"httpd-debuginfo-2.0.50-2.1", release:"FC2") )
{
 security_hole(0);
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_34761";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_34761 .
(SSRT051030 rev.1 - HP OpenView Event Correlation Services (OV ECS) Remote Unauthorized Privileged Access)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHSS_34761
See also : HPUX security bulletin 1225
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_34761";
...
if ( hpux_patch_installed (patches:"PHSS_34761 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_24097";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_24097 .
(Security Vulnerabilities in CDE on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_24097
See also : HPUX security bulletin 151
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_24097";
...
if ( hpux_patch_installed (patches:"PHSS_24097 PHSS_25419 PHSS_26029 PHSS_28173 ") )
{
 exit(0);
}

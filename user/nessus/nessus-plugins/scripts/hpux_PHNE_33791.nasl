...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_33791";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_33791 .
(SSRT5981 rev.1 - HP-UX Running the LP Subsystem, remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHNE_33791
See also : HPUX security bulletin 2139
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_33791";
...
if ( hpux_patch_installed (patches:"PHNE_33791 ") )
{
 exit(0);
}

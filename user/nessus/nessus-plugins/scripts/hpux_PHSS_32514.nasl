...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_32514";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_32514 .
(SSRT4829 rev.0 - OpenView Network Node Manager (OV NNM) remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32514
See also : HPUX security bulletin 1125
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_32514";
...
if ( hpux_patch_installed (patches:"PHSS_32514 PHSS_32692 PHSS_32816 PHSS_33072 PHSS_33222 PHSS_33344 PHSS_33459 PHSS_33662 PHSS_34098 ") )
{
 exit(0);
}

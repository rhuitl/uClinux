...
if (description)
{
 ...
 desc = 'The remote host is affected by the vulnerability described in GLSA-200503-29
...
';
 ...
 script_summary(english: 'GnuPG: OpenPGP protocol attack');
 exit(0);
}

include('qpkg.inc');
if (qpkg_check(package: "app-crypt/gnupg", unaffected: make_list("ge 1.4.1"), vulnerable: make_list("lt 1.4.1")

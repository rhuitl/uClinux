...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_26806";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_26806 .
(Sec. Vulnerability in SNMP (rev. 16))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_26806
See also : HPUX security bulletin 184
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_26806";
...
if ( hpux_patch_installed (patches:"PHSS_26806 PHSS_27652 PHSS_28001 ") )
{
 exit(0);
}

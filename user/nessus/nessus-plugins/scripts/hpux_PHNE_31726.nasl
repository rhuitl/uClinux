...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_31726";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_31726 .
(SSRT3622 rev.4 HP-UX Bind v920 Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHNE_31726
See also : HPUX security bulletin 290
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_31726";
...
if ( hpux_patch_installed (patches:"PHNE_31726 PHNE_32443 ") )
{
 exit(0);
}

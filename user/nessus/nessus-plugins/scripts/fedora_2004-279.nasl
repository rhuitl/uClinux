...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-279: gaim";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-279 (gaim).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-279.shtml
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"gaim-0.82-0.FC2", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"gaim-debuginfo-0.82-0.FC2", release:"FC2") )
{
 security_hole(0);
 exit(0);
}

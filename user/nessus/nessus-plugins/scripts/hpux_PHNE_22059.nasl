...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_22059";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_22059 .
(Sec. Vulnerability in ftpd **Rev.03**)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHNE_22059
See also : HPUX security bulletin 117
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_22059";
...
if ( hpux_patch_installed (patches:"PHNE_22059 PHNE_24394 PHNE_25217 PHNE_25894 ") )
{
 exit(0);
}

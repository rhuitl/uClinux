...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHKL_14243";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHKL_14243 .
(Security Vulnerability with land on HP-UX)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s800/10.X/PHKL_14243
See also : HPUX security bulletin 076
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHKL_14243";
...
if ( hpux_patch_installed (patches:"PHKL_14243 ") )
{
 exit(0);
}

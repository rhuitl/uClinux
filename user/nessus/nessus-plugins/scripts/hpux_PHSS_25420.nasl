...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_25420";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_25420 .
(Sec. Vulnerability in rpc.ttdbserverd (rev.3))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_25420
See also : HPUX security bulletin 168
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_25420";
...
if ( hpux_patch_installed (patches:"PHSS_25420 PHSS_26030 PHSS_28174 PHSS_29214 PHSS_30167 PHSS_30807 ") )
{
 exit(0);
}

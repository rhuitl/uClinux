...
if(description)
{
 ...
 name["english"] = "Solaris 8 (sparc) : 112390-12";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing Sun Security Patch number 112390-12
( Supplemental Encryption Kerberos V5: mech_krb5.so.1 patch).

You should install this patch for your system to be up-to-date.

Solution : http://sunsolve.sun.com/search/document.do?assetkey=1-21-112390-12-1
Risk factor : High";


 script_description(english:desc["english"]);
 
 summary["english"] = "Check for patch 112390-12"; 
...
e =  solaris_check_patch(release:"5.8", arch:"sparc", patch:"112390-12", obsoleted_by:"", package:"SUNWk5pk SUNWk5pkx SUNWk5pu SUNWk5pux");

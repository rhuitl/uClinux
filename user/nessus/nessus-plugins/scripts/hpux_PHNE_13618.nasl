...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_13618";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_13618 .
(Security Vulnerability in remote network commands)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/10.X/PHNE_13618
See also : HPUX security bulletin 090
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_13618";
...
if ( hpux_patch_installed (patches:"PHNE_13618 ") )
{
 exit(0);
}

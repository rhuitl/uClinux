...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_34131";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_34131 .
(SSRT4728 rev.4 - HP-UX running TCP/IP Remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHNE_34131
See also : HPUX security bulletin 2087
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_34131";
...
if ( hpux_patch_installed (patches:"PHNE_34131 ") )
{
 exit(0);
}
...
if ( hpux_check_patch( app:"Streams.STREAMS-RUN", version:"B.11.11") )
{
 security_hole(0);
 exit(0);
}

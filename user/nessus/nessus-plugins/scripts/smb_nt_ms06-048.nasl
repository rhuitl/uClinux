...
if(description)
{
 ...
 name["english"] = "Vulnerabilities in Microsoft Office Could Allow Remote Code Execution (922968)";
 ...
 if ( !isnull(v) ) 
  {
  	 if ( ( v[0] == 9 &&  v[1] == 0 && v[2] == 0 && v[3] < 8948 )  ||
	      ( v[0] == 10 && v[1] == 0 && v[2] < 6811 ) ||
	      ( v[0] == 11 && v[1] == 0 && v[2] < 8036 ) ) security_warning(port);
  }
}

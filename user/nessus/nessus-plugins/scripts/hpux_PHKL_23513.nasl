...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHKL_23513";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHKL_23513 .
(Sec. Vulnerability in setrlimit(1M) (rev. 1))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s800/10.X/PHKL_23513
See also : HPUX security bulletin 156
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHKL_23513";
...
if ( hpux_patch_installed (patches:"PHKL_23513 ") )
{
 exit(0);
}

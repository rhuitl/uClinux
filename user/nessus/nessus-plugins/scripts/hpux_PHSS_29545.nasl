...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_29545";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_29545 .
(SSRT3642 Potential Security Vulnerabilities Apache web server HP-UX VVOS and Web)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_29545
See also : HPUX security bulletin 285
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_29545";
...
if ( hpux_patch_installed (patches:"PHSS_29545 PHSS_29690 PHSS_30160 PHSS_30648 PHSS_31828 PHSS_32184 PHSS_33396 PHSS_34119 PHSS_35107 PHSS_35461 ") )
{
 exit(0);
}

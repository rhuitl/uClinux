...
if(description)
{
 ...
 name["english"] = "Solaris 2.5.1 (sparc) : 103603-16";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing Sun Security Patch number 103603-16
( ftp, in.ftpd, in.rexecd and in.rshd patch).

You should install this patch for your system to be up-to-date.

Solution : http://sunsolve.sun.com/search/document.do?assetkey=1-21-103603-16-1
Risk factor : High";


 script_description(english:desc["english"]);
 
 summary["english"] = "Check for patch 103603-16"; 
...
e =  solaris_check_patch(release:"5.5.1", arch:"sparc", patch:"103603-16", obsoleted_by:"", package:"SUNWcsu");

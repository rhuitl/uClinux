...
if (description)
{
 ...
 desc = 'The remote host is affected by the vulnerability described in GLSA-200606-05
...
Impact
    ...
    An attacker could exploit this vulnerability by sending HTTP
...
include('qpkg.inc');
if (qpkg_check(package: "www-servers/pound", unaffected: make_list("ge 2.0.5"), vulnerable: make_list("lt 2.0.5")

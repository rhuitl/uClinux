...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_30191";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_30191 .
(SSRT3656 rev.1 NLShp-ux_patches/s700_800/11.X/PHCO_30191 may contain any path)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHCO_30191
See also : HPUX security bulletin 294
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_30191";
...
if ( hpux_patch_installed (patches:"PHCO_30191 ") )
{
 exit(0);
}

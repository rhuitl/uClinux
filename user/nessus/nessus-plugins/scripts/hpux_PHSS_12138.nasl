...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_12138";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_12138 .
(Security Vulnerability in CDE on HP-UX 10.0[1,2,3])

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_12138
See also : HPUX security bulletin 072
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_12138";

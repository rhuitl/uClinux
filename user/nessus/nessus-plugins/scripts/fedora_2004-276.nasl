...
if(description)
{
 ...
 name["english"] = "Fedora Core 1 2004-276: krb5";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-276 (krb5).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-276.shtml
Risk Factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"krb5-devel-1.3.4-5", release:"FC1") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-libs-1.3.4-5", release:"FC1") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-server-1.3.4-5", release:"FC1") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-workstation-1.3.4-5", release:"FC1") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"krb5-debuginfo-1.3.4-5", release:"FC1") )
{
 security_hole(0);
 exit(0);
}

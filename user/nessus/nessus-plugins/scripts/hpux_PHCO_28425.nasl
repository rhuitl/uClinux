...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_28425";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_28425 .
(SSRT2341 calloc(3C) in HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHCO_28425
See also : HPUX security bulletin 310
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_28425";
...
if ( hpux_patch_installed (patches:"PHCO_28425 PHCO_29284 PHCO_29633 PHCO_29956 PHCO_32448 PHCO_33609 ") )
{
 exit(0);
}

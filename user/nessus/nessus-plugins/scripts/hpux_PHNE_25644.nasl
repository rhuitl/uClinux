...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_25644";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_25644 .
(SSRT4884 HP-UX TCP/IP Remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/patches_with_warnings/hp-ux_patches/s700_800/11.X/PHNE_25644
See also : HPUX security bulletin 1164
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_25644";
...
if ( hpux_patch_installed (patches:"PHNE_25644 PHNE_27063 PHNE_28089 PHNE_28895 PHNE_29887 PHNE_31247 PHNE_33159 PHNE_33628 PHNE_34135 PHNE_34672 ") )
{
 exit(0);
}

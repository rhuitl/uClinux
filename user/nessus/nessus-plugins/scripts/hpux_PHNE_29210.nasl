...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_29210";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_29210 .
(SSRT2384 rev.2 HP-UX RPC remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHNE_29210
See also : HPUX security bulletin 1020
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_29210";
...
if ( hpux_patch_installed (patches:"PHNE_29210 PHNE_29302 PHNE_29785 PHNE_29882 PHNE_30377 PHNE_30660 PHNE_31096 ") )
{
 exit(0);
}

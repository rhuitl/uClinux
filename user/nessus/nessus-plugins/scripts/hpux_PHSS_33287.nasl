...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_33287";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_33287 .
(SSRT051023 rev.5 - HP OpenView Network Node Manager (OV NNM) Remote Unauthorized Privileged Access)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_33287
See also : HPUX security bulletin 1224
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_33287";
...
if ( hpux_patch_installed (patches:"PHSS_33287 PHSS_34008 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "Fedora Core 3 2005-410: gaim";
...
include("rpm.inc");
if ( rpm_check( reference:"gaim-1.3.1-0.fc3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"gaim-debuginfo-1.3.1-0.fc3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}

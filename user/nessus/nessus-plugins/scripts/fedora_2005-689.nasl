...
if(description)
{
 ...
 name["english"] = "Fedora Core 4 2005-689: ethereal";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-689 (ethereal).
...
Solution : http://fedoranews.org//mediawiki/index.php/Fedora_Core_4_Update:_ethereal-0.10.12-1.FC4.2
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"ethereal-0.10.12-1.FC4.2", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"ethereal-gnome-0.10.12-1.FC4.2", release:"FC4") )
{
 security_hole(0);
 exit(0);
}

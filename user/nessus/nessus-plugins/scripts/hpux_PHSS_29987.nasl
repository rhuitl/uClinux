...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_29987";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_29987 .
(SSRT2332 rev.10 Apache Server Chunk Encoding)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_29987
See also : HPUX security bulletin 197
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_29987";
...
if ( hpux_patch_installed (patches:"PHSS_29987 PHSS_32358 ") )
{
 exit(0);
}

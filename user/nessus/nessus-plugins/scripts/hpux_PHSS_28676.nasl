...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_28676";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_28676 .
(SSRT3492 libDtSvc)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_28676
See also : HPUX security bulletin 308
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_28676";
...
if ( hpux_patch_installed (patches:"PHSS_28676 PHSS_29735 PHSS_30011 PHSS_30788 PHSS_32110 PHSS_33325 PHSS_35249 ") )
{
 exit(0);
}

# This script was automatically generated from the SSA-2006-215-01
...
script_xref(name: "SSA", value: "2006-215-01");
script_summary("SSA-2006-215-01 gnupg ");
name["english"] = "SSA-2006-215-01 gnupg ";
...
if (slackware_check(osver: "-current", pkgname: "gnupg", pkgver: "1.4.5", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
The package gnupg is vulnerable in Slackware -current
Upgrade to gnupg-1.4.5-i486-1 or newer.
');
}

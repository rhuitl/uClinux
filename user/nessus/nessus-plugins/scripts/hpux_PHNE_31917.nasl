...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_31917";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_31917 .
(SSRT061133 rev.12 - HP-UX Running Sendmail, Remote Execution of Arbitrary Code)

Solution : ftp://ftp.itrc.hp.com/patches_with_warnings/hp-ux_patches/s700_800/11.X/PHNE_31917
...
Risk factor : High';
 ...
 summary["english"] = "Checks for patch PHNE_31917";
...
if ( hpux_patch_installed (patches:"PHNE_31917 PHNE_34936 ") )
{
 exit(0);
}

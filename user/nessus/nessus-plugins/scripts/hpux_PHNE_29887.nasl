...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_29887";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_29887 .
(SSRT3552 rev.0 - HP-UX running ARPA transport, local Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHNE_29887
See also : HPUX security bulletin 1054
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_29887";
...
if ( hpux_patch_installed (patches:"PHNE_29887 PHNE_31247 PHNE_33159 PHNE_33628 PHNE_34135 PHNE_34672 ") )
{
 exit(0);
}

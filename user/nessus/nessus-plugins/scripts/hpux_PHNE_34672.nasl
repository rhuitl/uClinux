...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_34672";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_34672 .
(SSRT051021 rev.1 - HP-UX Running ARPA Transport Software, Local Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHNE_34672
See also : HPUX security bulletin 2151
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_34672";
...
if ( hpux_patch_installed (patches:"PHNE_34672 ") )
{
 exit(0);
}

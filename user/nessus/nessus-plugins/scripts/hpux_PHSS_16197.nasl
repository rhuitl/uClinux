...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_16197";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_16197 .
(Security Vulnerability in dtmail/rpc.ttdbserverd on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_16197
See also : HPUX security bulletin 084
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_16197";
...
if ( hpux_patch_installed (patches:"PHSS_16197 PHSS_19702 PHSS_19819 PHSS_22546 PHSS_23848 PHSS_24097 PHSS_25419 PHSS_26029 PHSS_28173 ") )
{
 exit(0);
}

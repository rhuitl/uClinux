...
if(description)
{
 ...
 name["english"] = "Fedora Core 3 2005-281: sharutils";
...
include("rpm.inc");
if ( rpm_check( reference:"sharutils-4.2.1-22.1.FC3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"sharutils-debuginfo-4.2.1-22.1.FC3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}

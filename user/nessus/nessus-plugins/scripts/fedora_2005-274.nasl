...
if(description)
{
 ...
 name["english"] = "Fedora Core 3 2005-274: telnet";
...
include("rpm.inc");
if ( rpm_check( reference:"telnet-0.17-32.FC3.2", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"telnet-server-0.17-32.FC3.2", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_exists(rpm:"telnet-", release:"FC3") )
{

...
if(description)
{
 ...
 name["english"] = "Fedora Core 1 2004-222: php";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-222 (php).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-222.shtml
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"php-4.3.8-1.1", prefix:"php-", release:"FC1") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_exists(rpm:"php-", release:"FC1") )
{

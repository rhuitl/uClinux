# This script was automatically generated from the SSA-2006-195-01
...
script_summary("SSA-2006-195-01 Samba DoS ");
name["english"] = "SSA-2006-195-01 Samba DoS ";
...
if (slackware_check(osver: "-current", pkgname: "samba", pkgver: "3.0.23", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
The package samba is vulnerable in Slackware -current
Upgrade to samba-3.0.23-i486-1 or newer.
');
}

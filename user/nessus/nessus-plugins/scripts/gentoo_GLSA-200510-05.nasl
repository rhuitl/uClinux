...
if (description)
{
 ...
 desc = 'The remote host is affected by the vulnerability described in GLSA-200510-05
...
';
 ...
 script_summary(english: 'Ruby: Security bypass vulnerability');
 exit(0);
}

include('qpkg.inc');
if (qpkg_check(package: "dev-lang/ruby", unaffected: make_list("ge 1.8.3"), vulnerable: make_list("lt 1.8.3")

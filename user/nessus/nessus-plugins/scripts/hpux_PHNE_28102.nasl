...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_28102";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_28102 .
(SSRT2330 Rev.2 rpc.yppasswdd)

Solution : ftp://ftp.itrc.hp.com/patches_with_warnings/hp-ux_patches/s700_800/11.X/PHNE_28102
See also : HPUX security bulletin 242
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_28102";
...
if ( hpux_patch_installed (patches:"PHNE_28102 PHNE_28567 PHNE_28982 PHNE_29210 PHNE_29302 PHNE_29785 PHNE_29882 PHNE_30377 PHNE_30660 PHNE_31096 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_33427";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_33427 .
(SSRT4728 rev.4 - HP-UX running TCP/IP Remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHNE_33427
See also : HPUX security bulletin 2087
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_33427";
...
if ( hpux_patch_installed (patches:"PHNE_33427 ") )
{
 exit(0);
}

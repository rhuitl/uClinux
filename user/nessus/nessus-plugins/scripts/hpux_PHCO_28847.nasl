...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_28847";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_28847 .
(SSRT061134 rev.1 - HP-UX Running swagentd Remote Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHCO_28847
See also : HPUX security bulletin 2105
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_28847";

...
if(description)
{
 ...
 name["english"] = "Solaris 10 (sparc) : 118667-02";
...
e =  solaris_check_patch(release:"5.10", arch:"sparc", patch:"118667-02", obsoleted_by:"", package:"SUNWj5dmx SUNWj5dvx SUNWj5rtx");

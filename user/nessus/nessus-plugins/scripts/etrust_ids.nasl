...
The remote host is running the Computer Associates eTrust Intrusion
...
if(description)
{
 ...
 name["english"] = "Computer Associates eTrust Intrusion Detection System detection";

 script_name(english:name["english"]);

 script_description(english:desc["english"]);

 summary["english"] = "Computer Associates eTrust Intrusion Detection System detection";
...
enc = blowfish_encrypt (data:first_packet);

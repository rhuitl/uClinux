...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_29734";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_29734 .
(SSRT3667 dtmailpr)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_29734
See also : HPUX security bulletin 300
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_29734";
...
if ( hpux_patch_installed (patches:"PHSS_29734 PHSS_30010 PHSS_30668 PHSS_32107 PHSS_32539 PHSS_35433 ") )
{
 exit(0);
}

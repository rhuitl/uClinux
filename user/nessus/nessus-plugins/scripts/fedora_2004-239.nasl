...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-239: libpng";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-239 (libpng).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-239.shtml
...
include("rpm.inc");
if ( rpm_check( reference:"libpng-1.2.5-8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"libpng-devel-1.2.5-8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"libpng-debuginfo-1.2.5-8", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_exists(rpm:"libpng-", release:"FC2") )
{

...
if(description)
{
 ...
 name["english"] = "Fedora Core 4 2005-929: epiphany";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-929 (epiphany).
...
include("rpm.inc");
if ( rpm_check( reference:"epiphany-1.6.5-2", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"epiphany-devel-1.6.5-2", release:"FC4") )
{
 security_hole(0);
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_29367";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_29367 .
(SSRT3589 Potential Security Vulnerability in dtprintinfo)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_29367
See also : HPUX security bulletin 289
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_29367";
...
if ( hpux_patch_installed (patches:"PHSS_29367 PHSS_30260 PHSS_33129 ") )
{
 exit(0);
}

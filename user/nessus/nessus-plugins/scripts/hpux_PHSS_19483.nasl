...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_19483";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_19483 .
(Security Vulnerability in rpc.cmsd)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_19483
See also : HPUX security bulletin 102
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_19483";

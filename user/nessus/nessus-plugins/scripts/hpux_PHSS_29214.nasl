...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_29214";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_29214 .
(SSRT2373 SSRT2374 SSRT3484 SSRT2405 SSRT2415 rev.2 CDE)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_29214
See also : HPUX security bulletin 263
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_29214";
...
if ( hpux_patch_installed (patches:"PHSS_29214 PHSS_30167 PHSS_30807 ") )
{
 exit(0);
}

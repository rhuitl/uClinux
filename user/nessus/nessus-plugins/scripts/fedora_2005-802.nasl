...
if(description)
{
 ...
 name["english"] = "Fedora Core 3 2005-802: pcre";
...
include("rpm.inc");
if ( rpm_check( reference:"pcre-4.5-3.1.1.fc3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"pcre-devel-4.5-3.1.1.fc3", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_exists(rpm:"pcre-", release:"FC3") )
{

# This plugin was written by Michel Arboi <mikhail@nessus.org>
# It is released under the GNU Public Licence (GPLv2)
#
# References: http://www.iana.org/assignments/protocol-numbers
#
...
if(description)
{
  ...
  name["english"] = "IP protocols scan";
...
Risk factor : None";
  ...
  summary["english"] = "Scans IP protocols";
...
if (! thorough_tests) exit(0);	# Too long / possibly unsafe
...
reject_nb = 0;
if (debug_level && defined_func("unixtime"))
  start_time = unixtime();

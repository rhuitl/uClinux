...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_27427";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_27427 .
(Potential Sec. Vulnerability in rpc.ttdbserver)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_27427
See also : HPUX security bulletin 199
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_27427";

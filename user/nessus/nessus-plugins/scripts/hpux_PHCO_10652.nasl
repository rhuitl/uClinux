...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_10652";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_10652 .
(Security Vulnerability in swinstall command)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHCO_10652
See also : HPUX security bulletin 064
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_10652";
...
if ( hpux_patch_installed (patches:"PHCO_10652 PHCO_12009 PHCO_13916 PHCO_14253 PHCO_16721 PHCO_19370 PHCO_21508 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_23797";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_23797 .
(Security Vulnerabilities in CDE on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_23797
See also : HPUX security bulletin 151
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_23797";
...
if ( hpux_patch_installed (patches:"PHSS_23797 PHSS_23800 PHSS_25138 PHSS_25194 PHSS_25787 PHSS_26490 PHSS_27427 PHSS_27869 PHSS_28675 PHSS_29734 PHSS_30010 PHSS_30668 PHSS_32107 PHSS_32539 PHSS_35433 ") )
{
 exit(0);
}

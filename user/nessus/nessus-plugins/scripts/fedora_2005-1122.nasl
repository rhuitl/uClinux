...
if(description)
{
 ...
 name["english"] = "Fedora Core 4 2005-1122: xpdf";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-1122 (xpdf).
...
include("rpm.inc");
if ( rpm_check( reference:"xpdf-3.01-0.FC4.3", release:"FC4") )
{
 security_hole(0);
 exit(0);
}

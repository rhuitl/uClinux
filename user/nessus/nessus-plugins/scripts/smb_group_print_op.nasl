...
It is possible to retrieve Users in the 'Print Operators' group
using the supplied credentials.

Description :

Using the supplied credentials it was possible to extract the member
list of group 'Print Operators'.
Members of this group can manage printers in a Windows Domain or
shutdown a server.
...
if(description)
{
 ...
 name["english"] = "Users in the 'Print Operator' group";
...
if( report )
{
 report = string (desc["english"],
		"\n\nPlugin output :\n\n",
		"The following users are in the 'Print Operators' group :\n",
		report);

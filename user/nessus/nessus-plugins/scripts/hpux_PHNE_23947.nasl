...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_23947";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_23947 .
(SSRT4883 ftp and ftpd remote unauthorized access)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/10.X/PHNE_23947
See also : HPUX security bulletin 162
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_23947";
...
if ( hpux_patch_installed (patches:"PHNE_23947 ") )
{
 exit(0);
}

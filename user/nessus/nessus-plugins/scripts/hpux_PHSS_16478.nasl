...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_16478";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_16478 .
(Security Vulnerability with HP OpenView Omniback II)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/10.X/PHSS_16478
See also : HPUX security bulletin 085
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_16478";
...
if ( hpux_patch_installed (patches:"PHSS_16478 ") )
{
 exit(0);
}

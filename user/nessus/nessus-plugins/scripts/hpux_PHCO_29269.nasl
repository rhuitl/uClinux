...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_29269";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_29269 .
...
Solution : ftp://ftp.itrc.hp.com/patches_with_warnings/hp-ux_patches/s700_800/11.X/PHCO_29269
See also : HPUX security bulletin 2102
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_29269";
...
if ( hpux_patch_installed (patches:"PHCO_29269 PHCO_30275 PHCO_32181 PHCO_33142 ") )
{
 exit(0);
}

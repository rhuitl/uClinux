...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_30669";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_30669 .
(SSRT4721 rev.0 HP-UX dtlogin unauthorized privileged access, Denial of Service (DoS))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_30669
See also : HPUX security bulletin 1038
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_30669";
...
if ( hpux_patch_installed (patches:"PHSS_30669 PHSS_30789 PHSS_32111 PHSS_32540 PHSS_33326 PHSS_34101 PHSS_35434 ") )
{
 exit(0);
}

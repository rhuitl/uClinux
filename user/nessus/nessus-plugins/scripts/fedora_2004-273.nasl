...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-273: mc";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-273 (mc).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-273.shtml
Risk Factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"mc-4.6.0-17.fc2", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"mc-debuginfo-4.6.0-17.fc2", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_exists(rpm:"mc-", release:"FC2") )
{

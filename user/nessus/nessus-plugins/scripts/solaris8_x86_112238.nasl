...
if(description)
{
 ...
 name["english"] = "Solaris 8 (i386) : 112238-13";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing Sun Security Patch number 112238-13
( mech_krb5.so.1 patch).

You should install this patch for your system to be up-to-date.

Solution : http://sunsolve.sun.com/search/document.do?assetkey=1-21-112238-13-1
Risk factor : High";


 script_description(english:desc["english"]);
 
 summary["english"] = "Check for patch 112238-13"; 
...
e =  solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"112238-13", obsoleted_by:"", package:"SUNWcsl SUNWgssdh SUNWgssk");

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_29912";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_29912 .
(SSRT3631 rev.9 HP-UX sendmail remote privileged access)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/11.X/PHNE_29912
See also : HPUX security bulletin 281
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_29912";
...
if ( hpux_patch_installed (patches:"PHNE_29912 ") )
{
 exit(0);
}

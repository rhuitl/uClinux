...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_25419";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_25419 .
(Sec. Vulnerability in rpc.ttdbserverd (rev.3))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_25419
See also : HPUX security bulletin 168
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_25419";
...
if ( hpux_patch_installed (patches:"PHSS_25419 PHSS_26029 PHSS_28173 ") )
{
 exit(0);
}

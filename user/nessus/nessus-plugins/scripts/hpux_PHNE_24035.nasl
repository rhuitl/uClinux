...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_24035";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_24035 .
(Sec. Vulnerability in rpcbind (rev.1))

Solution : ftp://ftp.itrc.hp.com/patches_with_warnings/hp-ux_patches/s700_800/11.X/PHNE_24035
See also : HPUX security bulletin 169
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_24035";

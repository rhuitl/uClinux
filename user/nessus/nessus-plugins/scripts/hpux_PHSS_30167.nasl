...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_30167";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_30167 .
(SSRT3492 libDtSvc)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_30167
See also : HPUX security bulletin 308
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_30167";
...
if ( hpux_patch_installed (patches:"PHSS_30167 PHSS_30807 ") )
{
 exit(0);
}

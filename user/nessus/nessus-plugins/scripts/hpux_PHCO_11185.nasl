...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_11185";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_11185 .
(Security Vulnerability in swinstall command)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHCO_11185
See also : HPUX security bulletin 064
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_11185";
...
if ( hpux_patch_installed (patches:"PHCO_11185 PHCO_11786 PHCO_15483 ") )
{
 exit(0);
}

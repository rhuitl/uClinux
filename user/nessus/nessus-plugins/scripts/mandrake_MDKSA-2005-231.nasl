...
#
# This plugin text was extracted from Mandrake Linux Security Advisory MDKSA-2005:231
#
...
if(description)
{
 ...
 name["english"] = "MDKSA-2005:231: ffmpeg";
...
Risk factor : High";
 ...
 summary["english"] = "Check for the version of the ffmpeg package";
...
include("rpm.inc");
if ( rpm_check( reference:"ffmpeg-0.4.9-0.pre1.5.1.20060mdk", release:"MDK2006.0", yank:"mdk") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"libffmpeg0-0.4.9-0.pre1.5.1.20060mdk", release:"MDK2006.0", yank:"mdk") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"libffmpeg0-devel-0.4.9-0.pre1.5.1.20060mdk", release:"MDK2006.0", yank:"mdk") )
{
 security_hole(0);
 exit(0);
}
if (rpm_exists(rpm:"ffmpeg-", release:"MDK2006.0") )
{

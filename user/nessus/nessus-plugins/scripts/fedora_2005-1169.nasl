...
if(description)
{
 ...
 script_cve_id("CAN-2005-3193", "CVE-2005-3191");
 
 name["english"] = "Fedora Core 4 2005-1169: xpdf";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-1169 (xpdf).
...
include("rpm.inc");
if ( rpm_check( reference:"xpdf-3.01-0.FC4.5", release:"FC4") )
{
 security_hole(0);
 exit(0);
}

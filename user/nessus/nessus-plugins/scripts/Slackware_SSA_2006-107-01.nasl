# This script was automatically generated from the SSA-2006-107-01
...
script_summary("SSA-2006-107-01 firefox ");
name["english"] = "SSA-2006-107-01 firefox ";
...
if (slackware_check(osver: "10.2", pkgname: "mozilla-firefox", pkgver: "1.5.0.2", pkgnum:  "1", pkgarch: "i686")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
The package mozilla-firefox is vulnerable in Slackware 10.2
Upgrade to mozilla-firefox-1.5.0.2-i686-1 or newer.
');
}
if (slackware_check(osver: "-current", pkgname: "mozilla-firefox", pkgver: "1.5.0.2", pkgnum:  "1", pkgarch: "i686")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '

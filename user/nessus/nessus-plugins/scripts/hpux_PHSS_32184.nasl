...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_32184";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_32184 .
(SSRT5902 rev.0 Apache 1.3 on VirtualVault potential remote Denial of Service (DoS) and execution of arbitrary code)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32184
See also : HPUX security bulletin 1113
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_32184";
...
if ( hpux_patch_installed (patches:"PHSS_32184 PHSS_33396 PHSS_34119 PHSS_35107 PHSS_35461 ") )
{
 exit(0);
}

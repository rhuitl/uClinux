...
if(description)
{
 ...
 script_cve_id("CVE-2006-1626", "CVE-2006-1303", "CVE-2006-2218", "CVE-2006-2382", "CVE-2006-2383", "CVE-2006-2384", "CVE-2006-2385");
 script_bugtraq_id(17404, 17820, 18303, 18309, 18320, 18321, 18328);

 name["english"] = "Cumulative Security Update for Internet Explorer (916281)";
...
{
if ( ( hotfix_missing(name:"916281") > 0 ) &&

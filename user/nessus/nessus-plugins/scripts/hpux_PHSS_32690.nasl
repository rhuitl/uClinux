...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_32690";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_32690 .
...
Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32690
See also : HPUX security bulletin 1140
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_32690";
...
if ( hpux_patch_installed (patches:"PHSS_32690 PHSS_33287 PHSS_34008 PHSS_35113 ") )
{
 exit(0);
}

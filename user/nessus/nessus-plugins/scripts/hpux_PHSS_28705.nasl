...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_28705";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_28705 .
(SSRT2393 rev.2 HP-UX Apache Vulnerabilities)

Solution : ftp://ftp.itrc.hp.com/patches_with_warnings/hp-ux_patches/s700_800/11.X/PHSS_28705
See also : HPUX security bulletin 224
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_28705";
...
if ( hpux_patch_installed (patches:"PHSS_28705 PHSS_28878 PHSS_29206 PHSS_29429 PHSS_29754 PHSS_30104 PHSS_30419 PHSS_31185 PHSS_32046 PHSS_32690 PHSS_33287 PHSS_34008 PHSS_35113 ") )
{
 exit(0);
}

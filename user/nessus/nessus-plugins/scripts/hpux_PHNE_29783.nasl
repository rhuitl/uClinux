...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_29783";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_29783 .
(SSRT4688 rev.1 HP-UX rpc.ypupdated remote unauthorized access)

Solution : ftp://ftp.itrc.hp.com/patches_with_warnings/hp-ux_patches/s700_800/11.X/PHNE_29783
See also : HPUX security bulletin 1002
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_29783";
...
if ( hpux_patch_installed (patches:"PHNE_29783 PHNE_29883 PHNE_30378 PHNE_30380 PHNE_30661 PHNE_31097 PHNE_31929 PHNE_32477 PHNE_32811 PHNE_33315 PHNE_33498 PHNE_33971 PHNE_34293 PHNE_34662 ") )
{
 exit(0);
}

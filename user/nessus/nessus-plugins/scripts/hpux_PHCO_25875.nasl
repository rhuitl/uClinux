...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_25875";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_25875 .
(Sec. Vulnerability in SD in HP-UX 11.00 and 11.11)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHCO_25875
See also : HPUX security bulletin 194
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_25875";
...
if ( hpux_patch_installed (patches:"PHCO_25875 PHCO_27672 PHCO_28847 PHCO_34568 ") )
{
 exit(0);
}

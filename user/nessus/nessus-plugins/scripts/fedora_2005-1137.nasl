...
if(description)
{
 ...
 name["english"] = "Fedora Core 4 2005-1137: curl";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-1137 (curl).
...
include("rpm.inc");
if ( rpm_check( reference:"curl-7.13.1-5.fc4", release:"FC4") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"curl-devel-7.13.1-5.fc4", release:"FC4") )
{
 security_hole(0);
 exit(0);
}

...
if (description)
{
 ...
 desc = 'The remote host is affected by the vulnerability described in GLSA-200510-22
...
';
 ...
 script_summary(english: 'SELinux PAM: Local password guessing attack');
 exit(0);
}

include('qpkg.inc');
if (qpkg_check(package: "sys-libs/pam", unaffected: make_list("ge 0.78-r3"), vulnerable: make_list("lt 0.78-r3")

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_27426";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_27426 .
(Potential Sec. Vulnerability in rpc.ttdbserver)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_27426
See also : HPUX security bulletin 199
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_27426";
...
if ( hpux_patch_installed (patches:"PHSS_27426 PHSS_27877 PHSS_29201 ") )
{
 exit(0);
}

# This script was automatically generated from the SSA-2006-045-01
...
script_summary("SSA-2006-045-01 fetchmail ");
name["english"] = "SSA-2006-045-01 fetchmail ";
...
if (slackware_check(osver: "8.1", pkgname: "fetchmail", pkgver: "6.3.2", pkgnum:  "1", pkgarch: "i386")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
The package fetchmail is vulnerable in Slackware 8.1
Upgrade to fetchmail-6.3.2-i386-1 or newer.
');
}
if (slackware_check(osver: "9.0", pkgname: "fetchmail", pkgver: "6.3.2", pkgnum:  "1", pkgarch: "i386")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
...
if (slackware_check(osver: "9.1", pkgname: "fetchmail", pkgver: "6.3.2", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
The package fetchmail is vulnerable in Slackware 9.1
Upgrade to fetchmail-6.3.2-i486-1 or newer.
');
}
if (slackware_check(osver: "10.0", pkgname: "fetchmail", pkgver: "6.3.2", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
...
if (slackware_check(osver: "10.1", pkgname: "fetchmail", pkgver: "6.3.2", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
...
if (slackware_check(osver: "10.2", pkgname: "fetchmail", pkgver: "6.3.2", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
...
if (slackware_check(osver: "-current", pkgname: "fetchmail", pkgver: "6.3.2", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '

...
if(description)
{
  ...
  name["english"] = "Format string on HTTP header value";
...
Risk factor : High";
 ...
 summary["english"] = "Sends an HTTP request with %s inside an HTTP header";
...
{
  req2 = ereg_replace(string: req, icase: 1, 
	pattern: strcat(header, ':[\r\n]*\r\n'),

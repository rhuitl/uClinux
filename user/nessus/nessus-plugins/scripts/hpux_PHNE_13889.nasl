...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_13889";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_13889 .
(Security Vulnerability with land on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s800/10.X/PHNE_13889
See also : HPUX security bulletin 076
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_13889";
...
if ( hpux_patch_installed (patches:"PHNE_13889 PHNE_14736 PHNE_15734 PHNE_17414 PHNE_18966 ") )
{
 exit(0);
}

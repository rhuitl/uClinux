...
#
# This plugin text was extracted from Mandrake Linux Security Advisory MDKSA-2005:074
#
...
if(description)
{
 ...
 name["english"] = "MDKSA-2005:074: gnome-vfs2";
...
vulnerability is present in the gnome-vfs2 code.

The updated packages have been patched to correct these issues.



Solution : http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:074
Risk factor : High";
 ...
 summary["english"] = "Check for the version of the gnome-vfs2 package";

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_25785";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_25785 .
(Sec. Vulnerability in dtspcd (rev. 3))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_25785
See also : HPUX security bulletin 175
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_25785";
...
if ( hpux_patch_installed (patches:"PHSS_25785 PHSS_26488 ") )
{
 exit(0);
}

# This script was automatically generated from the SSA-2006-217-01
...
script_xref(name: "SSA", value: "2006-217-01");
script_summary("SSA-2006-217-01 php ");
name["english"] = "SSA-2006-217-01 php ";
...
if (slackware_check(osver: "-current", pkgname: "php", pkgver: "4.4.3", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) desc = strcat(desc, '
The package php is vulnerable in Slackware -current
Upgrade to php-4.4.3-i486-1 or newer.
');
}

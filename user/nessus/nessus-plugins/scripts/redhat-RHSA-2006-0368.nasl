...
if(description)
{
 ...
 name["english"] = "RHSA-2006-0368: elfutils";
...
Solution : http://rhn.redhat.com/errata/RHSA-2006-0368.html
Risk factor : High';
...
include("rpm.inc");
if ( rpm_check( reference:"elfutils-0.94.1-2", release:"RHEL3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"elfutils-devel-0.94.1-2", release:"RHEL3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"elfutils-libelf-0.94.1-2", release:"RHEL3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"elfutils-libelf-devel-0.94.1-2", release:"RHEL3") )
{
 security_hole(0);
 exit(0);
}

if ( rpm_exists(rpm:"elfutils-", release:"RHEL3") )
{
 set_kb_item(name:"CVE-2005-1704", value:TRUE);
}

set_kb_item(name:"RHSA-2006-0368", value:TRUE);

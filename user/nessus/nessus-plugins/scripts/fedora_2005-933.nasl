...
if(description)
{
 ...
 name["english"] = "Fedora Core 3 2005-933: devhelp";
...
include("rpm.inc");
if ( rpm_check( reference:"devhelp-0.9.2-2.3.6", release:"FC3") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"devhelp-devel-0.9.2-2.3.6", release:"FC3") )
{
 security_hole(0);
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_26030";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_26030 .
(Sec. Vulnerability in dtspcd (rev. 3))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_26030
See also : HPUX security bulletin 175
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_26030";
...
if ( hpux_patch_installed (patches:"PHSS_26030 PHSS_28174 PHSS_29214 PHSS_30167 PHSS_30807 ") )
{
 exit(0);
}

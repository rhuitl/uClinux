...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2004-131: cvs";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2004-131 (cvs).
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-131.shtml
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"cvs-1.11.15-6", release:"FC2") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"cvs-debuginfo-1.11.15-6", release:"FC2") )
{
 security_hole(0);
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_29785";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_29785 .
(SSRT4688 rev.1 HP-UX rpc.ypupdated remote unauthorized access)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHNE_29785
See also : HPUX security bulletin 1002
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_29785";
...
if ( hpux_patch_installed (patches:"PHNE_29785 PHNE_29882 PHNE_30377 PHNE_30660 PHNE_31096 ") )
{
 exit(0);
}

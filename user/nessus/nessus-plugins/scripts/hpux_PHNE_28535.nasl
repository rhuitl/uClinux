...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_28535";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_28535 .
(SSRT3451 Potential Security Vulnerability in HP-UX network drivers (Data Leakage) (rev. 01))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700/10.X/PHNE_28535
See also : HPUX security bulletin 261
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_28535";
...
if ( hpux_patch_installed (patches:"PHNE_28535 ") )
{
 exit(0);
}

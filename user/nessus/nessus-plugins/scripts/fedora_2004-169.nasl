...
if(description)
{
 ...
 name["english"] = "Fedora Core 1 2004-169: cvs";
...
Solution : http://www.fedoranews.org/updates/FEDORA-2004-169.shtml
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"cvs-1.11.17-1", release:"FC1") )
{
 security_hole(0);
 exit(0);
}
if ( rpm_check( reference:"cvs-debuginfo-1.11.17-1", release:"FC1") )
{
 security_hole(0);
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_34202";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_34202 .
...
Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_34202
See also : HPUX security bulletin 2098
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_34202";
...
if ( hpux_patch_installed (patches:"PHSS_34202 PHSS_34949 ") )
{
 exit(0);
}
...
if ( hpux_check_patch( app:"OVPlatform.OVSNMP-MIN", version:"B.06.40.00") )
{
 security_hole(0);
 exit(0);
}
if ( hpux_check_patch( app:"OVPlatform.OVSNMP-MIN", version:"B.06.41.00") )
{
 security_hole(0);
 exit(0);
}

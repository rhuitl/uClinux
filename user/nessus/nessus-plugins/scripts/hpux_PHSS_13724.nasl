...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_13724";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_13724 .
(Security Vulnerability in CDE on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_13724
See also : HPUX security bulletin 075
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_13724";

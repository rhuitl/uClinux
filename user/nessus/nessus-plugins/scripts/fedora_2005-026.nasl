...
if(description)
{
 ...
 name["english"] = "Fedora Core 2 2005-026: kernel";
 
 script_name(english:name["english"]);
 
 desc["english"] = "
The remote host is missing the patch for the advisory FEDORA-2005-026 (kernel).
...
Solution : http://www.fedoranews.org/blog/index.php?p=277
Risk factor : High";
...
include("rpm.inc");
if ( rpm_check( reference:"kernel-2.6.10-   Release : 1.9_FC2", prefix:"kernel-", release:"FC2") )
{
 security_hole(0);
 exit(0);
}

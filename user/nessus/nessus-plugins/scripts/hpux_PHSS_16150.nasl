...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_16150";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_16150 .
(Security Vulnerability in dtmail/rpc.ttdbserverd on HP-UX)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_16150
See also : HPUX security bulletin 084
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_16150";
...
if ( hpux_patch_installed (patches:"PHSS_16150 PHSS_23355 PHSS_25136 PHSS_25548 PHSS_25785 PHSS_26488 ") )
{
 exit(0);
}

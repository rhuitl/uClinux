...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_30011";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_30011 .
(SSRT3657 rev.3 CDE libDtHelp)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_30011
See also : HPUX security bulletin 297
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_30011";
...
if ( hpux_patch_installed (patches:"PHSS_30011 PHSS_30788 PHSS_32110 PHSS_33325 PHSS_35249 ") )
{
 exit(0);
}

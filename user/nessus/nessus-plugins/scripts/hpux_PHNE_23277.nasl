...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHNE_23277";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHNE_23277 .
(Sec. Vulnerability in BIND)

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700_800/10.X/PHNE_23277
See also : HPUX security bulletin 144
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHNE_23277";
...
if ( hpux_patch_installed (patches:"PHNE_23277 ") )
{
 exit(0);
}

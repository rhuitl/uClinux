...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHKL_24249";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHKL_24249 .
(Sec. Vulnerability in setrlimit(1M) (rev. 1))

Solution : ftp://ftp.itrc.hp.com/hp-ux_patches/s700/10.X/PHKL_24249
See also : HPUX security bulletin 156
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHKL_24249";
...
if ( hpux_patch_installed (patches:"PHKL_24249 ") )
{
 exit(0);
}

...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_27259";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_27259 .
(HP DCE/9000 1.8 DCE Client IPv6 vulnerability)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_27259
See also : HPUX security bulletin 196
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_27259";

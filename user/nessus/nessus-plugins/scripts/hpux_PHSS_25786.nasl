...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHSS_25786";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHSS_25786 .
(Sec. Vulnerability in dtspcd (rev. 3))

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/10.X/PHSS_25786
See also : HPUX security bulletin 175
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHSS_25786";
...
if ( hpux_patch_installed (patches:"PHSS_25786 PHSS_26489 PHSS_27426 PHSS_27877 PHSS_29201 ") )
{
 exit(0);
}

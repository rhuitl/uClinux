...
if(description)
{
 ...
 name["english"] = "HP-UX Security patch : PHCO_17601";
 
 script_name(english:name["english"]);
 
 desc["english"] = '
The remote host is missing HP-UX Security Patch number PHCO_17601 .
(Security Vulnerability with ftp on HP-UX 11.00)

Solution : ftp://ftp.itrc.hp.com/superseded_patches/hp-ux_patches/s700_800/11.X/PHCO_17601
See also : HPUX security bulletin 094
Risk factor : High';

 script_description(english:desc["english"]);
 
 summary["english"] = "Checks for patch PHCO_17601";

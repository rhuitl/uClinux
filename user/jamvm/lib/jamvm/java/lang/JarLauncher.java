...
public class JarLauncher {
    public static void main(String[] args) {
        String jarFile = System.getProperty("java.class.path", null);
        ...
        try {
            ...
            if(manifest == null)
                System.err.println("Couldn't read manifest from " + jar.getName() + " (invalid jar file?).");
            else {
                String mainAttr = manifest.getMainAttributes().getValue(Name.MAIN_CLASS);

                if(mainAttr == null)
                    System.err.println("Couldn't find Main-Class attribute in " +

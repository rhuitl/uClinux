...
__db_env_cachesize_1(__env_cachesize_msg *argp, CLIENT *clnt)
{
...
__env_close_reply *
__db_env_close_1(__env_close_msg *argp, CLIENT *clnt)
{
...
__env_create_reply *
__db_env_create_1(__env_create_msg *argp, CLIENT *clnt)
{
...
__env_flags_reply *
__db_env_flags_1(__env_flags_msg *argp, CLIENT *clnt)
{
...
__env_open_reply *
__db_env_open_1(__env_open_msg *argp, CLIENT *clnt)
{
...
__env_remove_reply *
__db_env_remove_1(__env_remove_msg *argp, CLIENT *clnt)
{
...
__txn_abort_reply *
__db_txn_abort_1(__txn_abort_msg *argp, CLIENT *clnt)
{
...
__txn_begin_reply *
__db_txn_begin_1(__txn_begin_msg *argp, CLIENT *clnt)
{
...
__txn_commit_reply *
__db_txn_commit_1(__txn_commit_msg *argp, CLIENT *clnt)
{
...
__db_db_bt_maxkey_1(__db_bt_maxkey_msg *argp, CLIENT *clnt)
{
...
__db_db_bt_minkey_1(__db_bt_minkey_msg *argp, CLIENT *clnt)
{
...
__db_close_reply *
__db_db_close_1(__db_close_msg *argp, CLIENT *clnt)
{
...
__db_create_reply *
__db_db_create_1(__db_create_msg *argp, CLIENT *clnt)
{
...
__db_del_reply *
__db_db_del_1(__db_del_msg *argp, CLIENT *clnt)
{
...
__db_db_extentsize_1(__db_extentsize_msg *argp, CLIENT *clnt)
{
...
__db_flags_reply *
__db_db_flags_1(__db_flags_msg *argp, CLIENT *clnt)
{
...
__db_get_reply *
__db_db_get_1(__db_get_msg *argp, CLIENT *clnt)
{
...
__db_db_h_ffactor_1(__db_h_ffactor_msg *argp, CLIENT *clnt)
{
...
__db_h_nelem_reply *
__db_db_h_nelem_1(__db_h_nelem_msg *argp, CLIENT *clnt)
{
...
__db_db_key_range_1(__db_key_range_msg *argp, CLIENT *clnt)
{
...
__db_lorder_reply *
__db_db_lorder_1(__db_lorder_msg *argp, CLIENT *clnt)
{
...
__db_open_reply *
__db_db_open_1(__db_open_msg *argp, CLIENT *clnt)
{
...
__db_pagesize_reply *
__db_db_pagesize_1(__db_pagesize_msg *argp, CLIENT *clnt)
{
...
__db_put_reply *
__db_db_put_1(__db_put_msg *argp, CLIENT *clnt)
{
...
__db_re_delim_reply *
__db_db_re_delim_1(__db_re_delim_msg *argp, CLIENT *clnt)
{
...
__db_re_len_reply *
__db_db_re_len_1(__db_re_len_msg *argp, CLIENT *clnt)
{
...
__db_re_pad_reply *
__db_db_re_pad_1(__db_re_pad_msg *argp, CLIENT *clnt)
{
...
__db_remove_reply *
__db_db_remove_1(__db_remove_msg *argp, CLIENT *clnt)
{
...
__db_rename_reply *
__db_db_rename_1(__db_rename_msg *argp, CLIENT *clnt)
{
...
__db_stat_reply *
__db_db_stat_1(__db_stat_msg *argp, CLIENT *clnt)
{
...
__db_swapped_reply *
__db_db_swapped_1(__db_swapped_msg *argp, CLIENT *clnt)
{
...
__db_sync_reply *
__db_db_sync_1(__db_sync_msg *argp, CLIENT *clnt)
{
...
__db_cursor_reply *
__db_db_cursor_1(__db_cursor_msg *argp, CLIENT *clnt)
{
...
__db_join_reply *
__db_db_join_1(__db_join_msg *argp, CLIENT *clnt)
{
...
__dbc_close_reply *
__db_dbc_close_1(__dbc_close_msg *argp, CLIENT *clnt)
{
...
__dbc_count_reply *
__db_dbc_count_1(__dbc_count_msg *argp, CLIENT *clnt)
{
...
__dbc_del_reply *
__db_dbc_del_1(__dbc_del_msg *argp, CLIENT *clnt)
{
...
__dbc_dup_reply *
__db_dbc_dup_1(__dbc_dup_msg *argp, CLIENT *clnt)
{
...
__dbc_get_reply *
__db_dbc_get_1(__dbc_get_msg *argp, CLIENT *clnt)
{
...
__dbc_put_reply *
__db_dbc_put_1(__dbc_put_msg *argp, CLIENT *clnt)
{

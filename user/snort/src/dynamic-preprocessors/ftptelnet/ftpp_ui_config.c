...
int ftpp_ui_config_default(FTPTELNET_GLOBAL_CONF *GlobalConf)
{
     ...
     */
    ftpp_ui_config_reset_ftp_client(&GlobalConf->global_ftp_client, 1);
    ftpp_ui_config_reset_ftp_server(&GlobalConf->global_ftp_server, 1);
                            ...
                            FTP_SERVER_PROTO_CONF *ServerConf)
{
    ...
    if((iRet = ftpp_ui_server_lookup_add(GlobalConf->server_lookup,
                                         ServerIP, ServerConf)))
    {
        /*
                            ...
                            FTP_CLIENT_PROTO_CONF *ClientConf)
{
    ...
    if((iRet = ftpp_ui_client_lookup_add(GlobalConf->client_lookup, ClientIP, 
                                       ClientConf)))
    {
        /*
         * Already added key will return a generic non-fatal

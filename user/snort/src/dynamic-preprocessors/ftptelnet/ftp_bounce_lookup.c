                            ...
                            FTP_BOUNCE_TO *BounceTo)
{
    ...
    if((iRet = KMapAdd(BounceLookup, (void *)ip, len, (void *)BounceTo)))
    {
        /*
                                       ...
                                       char *ip, int len, int *iError)
{
    ...
    *iError = FTPP_SUCCESS;
    ...
    if(!(BounceTo = (FTP_BOUNCE_TO *)KMapFind(BounceLookup,(void *)ip,len)))
    {
                                            ...
                                            int *iError)
{
    ...
    *iError = FTPP_SUCCESS;
    ...
    if(!(BounceTo = (FTP_BOUNCE_TO *)KMapFindFirst(BounceLookup)))
    {
        *iError = FTPP_NOT_FOUND;
    }
                                           ...
                                           int *iError)
{
    ...
    *iError = FTPP_SUCCESS;
    ...
    if(!(BounceTo = (FTP_BOUNCE_TO *)KMapFindNext(BounceLookup)))
    {
        *iError = FTPP_NOT_FOUND;
    }

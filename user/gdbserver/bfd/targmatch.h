...
{ "arm-*-elf", NULL },{ "arm-*-linux*", NULL },{ "armv*-*-linux-gnu",
...
{ "i[3456]86-*-elf", NULL },{ "i[3456]86-*-sco3.2v5*", NULL },{ "i[3456]86-*-freebsdelf*", NULL },
...
{ "i[3456]86-*-aix*", NULL },{ "i[3456]86*-*-rtems*",
&i386coff_vec },
#endif
...
{ "mips-dec-netbsd*", NULL },{ "mips*el*-*-netbsd*",
...
{ "mips*el*-*-linux-gnu*", NULL },{ "mips*el*-*-openbsd*",
&bfd_elf32_littlemips_vec },
#endif
...
{ "mips*-*-linux-gnu*", NULL },{ "mips*-*-openbsd*",
&bfd_elf32_bigmips_vec },
#endif
...
{ "powerpcle-*-solaris2*", NULL },{ "powerpcle-*-linux-gnu*", NULL },{ "powerpcle-*-vxworks*",

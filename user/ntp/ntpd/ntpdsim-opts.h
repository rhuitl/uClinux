...
typedef enum {
        ...
        INDEX_OPT_QUIT             = 24,
        INDEX_OPT_IMMEDIATESET     = 25,
        INDEX_OPT_PROPAGATIONDELAY = 26,
        INDEX_OPT_UPDATEINTERVAL   = 27,
        INDEX_OPT_STATSDIR         = 28,
        INDEX_OPT_ENDSIMTIME       = 29,
        INDEX_OPT_TRUSTEDKEY       = 30,
        INDEX_OPT_FREQERR          = 31,
        INDEX_OPT_WALKNOISE        = 32,
        INDEX_OPT_USER             = 33,
        INDEX_OPT_VAR              = 34,
        INDEX_OPT_DVAR             = 35,
        INDEX_OPT_SLEW             = 36,
...
# endif
# ifdef    IMMEDIATESET
#  warning undefining IMMEDIATESET due to option name conflict
#  undef   IMMEDIATESET
# endif
...
#define VALUE_OPT_IMMEDIATESET   'Q'
...
/* extracted from /usr/share/autogen/opthead.tpl near line 360 */
